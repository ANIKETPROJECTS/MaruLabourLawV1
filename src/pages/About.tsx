          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 lg:gap-5">
            {teamMembers.map((m, i) => (
              <motion.div key={i}
                ...
                {/* Photo */}
                <div className="relative overflow-hidden shrink-0 h-[220px] sm:h-[300px] lg:h-[360px]"
                  style={{ backgroundColor: '#ffffff' }}>
                ...
                {/* Details */}
                <div className="flex-1 flex flex-col items-center justify-center text-center px-3 py-3 lg:px-6 lg:py-5">
